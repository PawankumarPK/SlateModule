package com.technocomsolutions.slate.utils;
...
public class PaintView extends View {
    ...
    public PaintView(Context context, AttributeSet attrs) {
        ...
        //  board = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.slate_border);
        // board = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.green_board);

        mEmboss = new EmbossMaskFilter(new float[]{1, 1, 1}, 0.4f, 6, 3.5f);
        mBlur = new BlurMaskFilter(5, BlurMaskFilter.Blur.NORMAL);
    }

    public void init(DisplayMetrics metrics, View view) {
        int height = metrics.heightPixels;
        int width = metrics.widthPixels;
        //this.view = view;
        mBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
        mCanvas = new Canvas(mBitmap);
        // mCanvas.drawBitmap(board, 0f, 0f, null);
